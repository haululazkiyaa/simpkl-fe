...
export default function UploadExcelDrawerView(props) {
  ...
  const handleDownloadTemplate = () => {
    ...
    refreshToken((status, token) => {
      if (status) {
        ...
        link.href = `/templates/template-data-siswa.xlsx`;
  ...
  const handleUploadExcel = (e) => {
    ...
    refreshToken((status, token) => {
      if (status) {
        ...
        importExcelSiswa(formData, token, (status, message) => {
          clearInterval(progressInterval);
          setUploadProgress(100);

          if (status) {
            toast.success("Sukses! Data siswa berhasil diunggah.", {
              autoClose: 3000,
              hideProgressBar: false,
              closeOnClick: true,
              pauseOnHover: true,
            ...
            toast.error("Gagal mengunggah data siswa!", {
              autoClose: 3000,
              hideProgressBar: false,
              closeOnClick: true,
              pauseOnHover: true,
  ...
  return (
    <>
      ...
      <Drawer title="Unggah Data Siswa dari Excel" id={id}>
        {message !== "success" ? (
          <form
          ...
          >
            <div className="mb-6">
              <p className="text-sm text-gray-600 dark:text-gray-400 mb-4">
                ...
                siswa yang ingin ditambahkan, lalu unggah kembali file Excel
                tersebut.
              </p>
