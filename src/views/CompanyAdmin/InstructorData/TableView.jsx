  ...
  const columns = useMemo(
    () => [
      ...
      columnHelper.accessor("no_hp", {
        header: "No. HP",
        cell: (info) => (
          <div className="text-left truncate">{info.getValue() ?? "-"}</div>
        ),
      }),
      ...
      columnHelper.accessor("user.temp_password", {
        header: "Password Sementara",
        cell: (info) => <div>{info.getValue() || "-"}</div>,
      }),
      columnHelper.accessor("id", {
        id: "lihat",
        header: "Daftar Siswa Bimbingan",
        cell: (info) => (
      ...
      <div className="mb-4 flex flex-col md:flex-row justify-between items-start md:items-center">
        <div className="relative w-full md:w-96 mb-4 md:mb-0">
          ...
          <input
            ...
            placeholder="Cari nama instruktur, no hp, username..."
            value={searchTerm}
                ...
                {headerGroup.headers.map((header) => (
                  <th
                    ...
                    className={`px-6 py-3 ${
                      ...
                      ["edit", "lihat"].includes(header.id) ? "w-32 px-3" : ""
                    }`}
                  ...
                  {row.getVisibleCells().map((cell) => (
                    <td
                      ...
                      className={`px-6 py-4 ${
                        ...
                        ["edit", "lihat"].includes(cell.column.id)
                          ? "w-32 px-3"
                          : ""
                      }`}
                    >
